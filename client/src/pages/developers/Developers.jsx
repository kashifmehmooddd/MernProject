          ...
          {profiles.map(profile => (
            <div className="card m-5 overflow-auto" key={profile.id}>
              <div className="profile m-5">
                ...
                <div className='ms-5'>
                  <div className="company m-2"><strong>Company: </strong>{profile.company.toUpperCase()}</div>
                  <div className="githubusername m-2"><strong>github: </strong>{profile.githubusername.toUpperCase()}</div>
                  <div className="website m-2"><strong>website: </strong><a href={profile.website} target="_blank">Visit my website</a></div>
                </div>
                <div className='ms-5'>
